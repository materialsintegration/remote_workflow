...
EXEC_SOLVER = "python3.6 /home/misystem/assets/modules/misrc_distributed_computing_assist_api/debug/mi-system-wf.py https://dev-u-tokyo.mintsys.jp rme-u-tokyo %s /home/manaka/create_inp_file_api.sh"%(wf_tool.RunInfo["miwf_api_token"])
pwd
