...
logfile="W000020000000434_"`date +%Y-%m-%d_%H%M%S`".log"
# パラメータ取得用
#python3.6 ~/assets/modules/workflow_python_lib/workflow_params.py workflow_id:W000020000000434 misystem:nims-dev.mintsys.jp version:v4

# 実行
python3.6 ~/assets/modules/workflow_python_lib/workflow_execute.py \
workflow_id:W000020000000434 \
