...
PREFIX=~/local
#echo 'module add cmake/3.20.2' > ./sh.local
#echo 'module add mpi/openmpi-x86_64' >> ./sh.local
#echo 'module add mkl' >> ./sh.local
...
./l_BaseKit_p_2022.1.2.146_offline.sh -a --action remove -s
./l_HPCKit_p_2022.1.2.117_offline.sh -a --action remove -s
...
./l_BaseKit_p_2022.1.2.146_offline.sh -a --install-dir /home/misystem/local/intel/oneapi -s --eula accept
echo "intel oneapi Basekit installed."
echo "installing oneapi HPCkit..."
./l_HPCKit_p_2022.1.2.117_offline.sh -a --install-dir /home/misystem/local/intel/oneapi -s --eula accept
